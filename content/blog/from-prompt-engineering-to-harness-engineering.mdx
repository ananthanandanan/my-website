...
images: ['/images/individualBlogPostImages/harness-engineering-system.png']
layout: PostLayout
...
![A system diagram showing raw documents flowing through ingestion into a harness of knowledge base, tools, policy, retrieval, agent, verification, and cited answer](/images/individualBlogPostImages/harness-engineering-system.png)
